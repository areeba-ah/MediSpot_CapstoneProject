...
public class QRScanner extends AppCompatActivity {
    ...
    public class MyImageAnalysis implements ImageAnalysis.Analyzer {
            ...
            BarcodeScannerOptions options =
                    new BarcodeScannerOptions.Builder()
                            .setBarcodeFormats(Barcode.FORMAT_AZTEC, Barcode.FORMAT_DATA_MATRIX, Barcode.FORMAT_PDF417,
                                    ...
                                    Barcode.FORMAT_CODE_39, Barcode.FORMAT_EAN_8,  Barcode.FORMAT_QR_CODE)
                            .build();
        ...
        private void readerQRcodeData(List<Barcode> barcodes) {
            String rawValue;
    ...
    public void search(String rawValue,  int counter){
        ...
        Toast.makeText(getApplicationContext(), "QR code -> "+rawValue, Toast.LENGTH_SHORT).show();
        Intent search = new Intent(getApplicationContext(), ResultPage.class);
        search.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
        search.putExtra("source", "ByQRcode");
        search.putExtra("QRcode", rawValue.trim());
