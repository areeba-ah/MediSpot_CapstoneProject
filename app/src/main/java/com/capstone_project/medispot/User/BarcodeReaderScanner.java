...
public class BarcodeReaderScanner extends AppCompatActivity{
        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    {
                        ActivityCompat.requestPermissions(BarcodeReaderScanner.this,new String[]{Manifest.permission.CAMERA},101);
                    }
    ...
    public void search(String rawValue,  int counter){
        ...
        search.putExtra("Barcode", rawValue);
