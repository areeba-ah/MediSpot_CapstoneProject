...
public class DrugList extends AppCompatActivity implements drugListAdapter.onClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new drugListAdapter((Context) this,arrayList,this);
        recyclerView.setAdapter(adapter);

        View blurView = findViewById(R.id.blurView);


        DrawerNavigation.setupNavigationDrawer(this, drawerLayout, navigationView, menuIcon, contentView, blurView, R.id.drug_index);
